...
public class Main{
    public static void main(String[] args) {
        ...
        Question javaQuestion = system.createQuestion(alice, "What is polymorphism in Java?",
                "Can someone explain polymorphism in Java with an example?",
                Arrays.asList("java", "oop"));

        // Bob answers Alice's question
        Answer bobAnswer = system.createAnswer(bob, javaQuestion,
                "Polymorphism in Java is the ability of an object to take on many forms...");

        // Charlie comments on the question
        system.createComment(charlie, javaQuestion, "Great question! I'm also interested in learning about this.");

        // Alice comments on Bob's answer
        system.createComment(alice, bobAnswer, "Thanks for the explanation! Could you provide a code example?");
        ...
        Question pythonQuestion = system.createQuestion(bob, "How to use list comprehensions in Python?",
        ...
        Answer aliceAnswer = system.createAnswer(alice, pythonQuestion,
        ...
        System.out.println("Asked by: " + javaQuestion.getUser().getName());
        System.out.println("Tags: " + javaQuestion.getTag().stream().map(Tags::getName).reduce((a, b) -> a + ", " + b).orElse(""));
        System.out.println("Votes: " + javaQuestion.getVoteCount());
        System.out.println("Comments: " + javaQuestion.getComments().size());
        System.out.println("\nAnswer by " + bobAnswer.getUser().getName() + ":");
        ...
        List<Question> searchResults = system.searchQuestionByTitle("java");
        for (Question q : searchResults) {
            System.out.println(q.getTitle());
        }

        System.out.println("\nSearch Results for 'python':");
        searchResults = system.searchQuestionByTitle("python");
        for (Question q : searchResults) {
            System.out.println(q.getTitle());
        }
        ...
        System.out.println("\nBob's Questions:");
        List<Question> bobQuestions = system.getQuestionByUser(bob);
