...
public class Main{
    public static void main(String[] args) {
        ...
        // Post a job listing
        Job jobPosting = new Job("1", "Software Developer", "We are hiring!", Arrays.asList("Java", "Python"), "San Francisco", new Timestamp(System.currentTimeMillis()));
        ...
        List<Job> jobPostingResults = linkedInService.searchJobs("Software");
        System.out.println("Job Posting Results:");
        for (Job posting : jobPostingResults) {
